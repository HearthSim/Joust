...
export default class TexturePreloader extends Stream.Writable {
	...
	protected assetQueue = [
		...
		"hero_power",
		"inhand_mulligan",
		"inhand_minion_neutral",
		"inhand_spell_neutral",
		"inhand_weapon_neutral",
		...
		"icon_poisonous",
		"icon_trigger",
		"inplay_minion_frozen",
		"inplay_minion_legendary",
		"inplay_minion_taunt",
		"inplay_minion_divine_shield",
		"inplay_minion_stealth",
		"inplay_weapon",
		"inplay_weapon_dome",
		"healing",
		"damage",
		...
		"inplay_hero_frozen",
		"inplay_hero_immune",
		"inplay_minion_buffed",
		"inplay_minion_enraged",
		"inplay_minion_immune",
		"inplay_minion_silenced",
		"inplay_minion_untargetable",
	];

	constructor(
		public cardArt?: (cardId: string) => string,
	...
	public consume() {
		...
		if (
			(!this.cardArt || !this.cardArtQueue.length) &&
			(!this.assets || !this.assetQueue.length)
		) {
			return;
		}
	...
	public isDone(): boolean {
		return (
			this.cardArtQueue.length + this.assetQueue.length + this.working ==
			0
		);
	}
}
