...
abstract class EntityInPlay<
	P extends EntityInPlayProps
> extends React.Component<P, EntityInPlayState> {
					...
					(descriptor: GameStateDescriptor) => {
						switch (descriptor.type) {
							case BlockType.ATTACK:
								if (
									this.props.entity.id == descriptor.entityId
								) {
									classNames.push("attacking");
								} else if (
									this.props.entity.id == descriptor.target
								) {
							...
							case BlockType.TRIGGER:
								if (
									descriptor.entityId == this.props.entity.id
								) {
