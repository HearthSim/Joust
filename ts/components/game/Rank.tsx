...
class Rank extends React.Component<RankProps, {}> {
    public render():JSX.Element {
        if(this.props.rank > 0) {
            return (
                <div className="rank">
                    <RankArt rank={this.props.rank} assetDirectory={this.props.assetDirectory}/>
        ...
        if(this.props.legendRank > 0){
            return (
                <div className="rank">
                    <RankArt legendRank={this.props.legendRank} assetDirectory={this.props.assetDirectory}/>
