...
export default class GameState {
	constructor(
		...
		protected _optionTree?: Immutable.Map<
			number,
		...
		if (!this._entityTree) {
			this._entityTree = Immutable.Map<
				number,
				Immutable.Map<number, Immutable.Map<number, Entity>>
			>();
		}
		...
		if (!this._optionTree) {
			this._optionTree = Immutable.Map<
				number,
				Immutable.Map<number, Immutable.Map<number, Option>>
			>();
		}
